...
class WildSearcher : public Searcher<Profile, Filter, Result>
{
public:
    /**
    ...
    WildSearcher(Method method, Encounter encounter, Lead lead, const EncounterArea &encounterArea, const Profile &profile,
                 const Filter &filter) :
        Searcher<Profile, Filter, Result>(method, profile, filter), encounterArea(encounterArea), encounter(encounter), lead(lead)
    {
    }
