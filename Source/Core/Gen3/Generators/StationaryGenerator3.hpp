...
public:
    ...
    StationaryGenerator3(u32 initialAdvances, u32 maxAdvances, u16 tid, u16 sid, u8 genderRatio, Method method, const StateFilter &filter);
...
private:
    ...
    std::vector<State> generateWishmaker(u32 seed) const;
};
