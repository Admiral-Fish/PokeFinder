...
StaticGenerator5::StaticGenerator5(u32 initialAdvances, u32 maxAdvances, u16 tid, u16 sid, u8 gender, u8 genderRatio, Method method,
...
std::vector<StaticState> StaticGenerator5::generate(u64 seed) const
{
    switch (method)
    {
    ...
    return std::vector<StaticState>();
}

std::vector<StaticState> StaticGenerator5::generateRoamerIVs(u64 seed) const
{
...
std::vector<StaticState> StaticGenerator5::generateIVs(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateRoamerCGear(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateCGear(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateStatic(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateRoamer(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateGift(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateEntraLink(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateLarvestaEgg(u64 seed) const
{
    std::vector<StaticState> states;
...
std::vector<StaticState> StaticGenerator5::generateHiddenGrotto(u64 seed) const
{
    std::vector<StaticState> states;
