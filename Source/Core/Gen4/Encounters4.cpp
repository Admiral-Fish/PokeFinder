...
constexpr std::array<StaticTemplate4, 12> starters = {
    StaticTemplate4(Game::DPPt, 387, 5), // Turtwig @ Lake Verity / Route 201
    StaticTemplate4(Game::DPPt, 390, 5), // Chimchar
    StaticTemplate4(Game::DPPt, 393, 5), // Piplup

    StaticTemplate4(Game::HGSS, 1, 5), // Bulbasaur @ Pallet Town
    StaticTemplate4(Game::HGSS, 4, 5), // Charmander
    StaticTemplate4(Game::HGSS, 7, 5), // Squirtle
    StaticTemplate4(Game::HGSS, 152, 5), // Chikorita @ New Bark Town
    StaticTemplate4(Game::HGSS, 155, 5), // Cyndaquil
    StaticTemplate4(Game::HGSS, 158, 5), // Totodile
    StaticTemplate4(Game::HGSS, 252, 5), // Treecko @ Saffron City
    StaticTemplate4(Game::HGSS, 255, 5), // Torchic
    StaticTemplate4(Game::HGSS, 258, 5) // Mudkip
};

constexpr std::array<StaticTemplate4, 7> fossils = {
    StaticTemplate4(Game::Gen4, 138, 20), // Omanyte @ Mining Museum / Pewter City
    StaticTemplate4(Game::Gen4, 140, 20), // Kabuto
    StaticTemplate4(Game::Gen4, 142, 20), // Aerodactyl
    StaticTemplate4(Game::Gen4, 345, 20), // Lileep
    StaticTemplate4(Game::Gen4, 347, 20), // Anorith
    StaticTemplate4(Game::Gen4, 408, 20), // Cranidos
    StaticTemplate4(Game::Gen4, 410, 20) // Shieldon
};

constexpr std::array<StaticTemplate4, 14> gifts = {
    StaticTemplate4(Game::DP, 133, 5), // Eevee @ Hearthome City
    StaticTemplate4(Game::Platinum, 133, 20), // Eevee
    StaticTemplate4(Game::Platinum, 137, 25), // Porygon @ Veilstone City
    StaticTemplate4(Game::Platinum, 175, 1), // Togepi egg @ Cynthia
    StaticTemplate4(Game::DP, 440, 1), // Happiny egg @ Traveling Man
    StaticTemplate4(Game::DPPt, 447, 1), // Riolu egg @ Riley

    StaticTemplate4(Game::HGSS, 72, 15), // Tentacool @ Cianwood City
    StaticTemplate4(Game::HGSS, 133, 5), // Eevee @ Goldenrod City
    StaticTemplate4(Game::HGSS, 147, 15), // Dratini @ Dragon's Den
    StaticTemplate4(Game::HGSS, 236, 10), // Tyrogue @ Mt. Mortar
    StaticTemplate4(Game::HGSS, 175, 1), // Togepi Egg @ Mr. Pokemon
    StaticTemplate4(Game::HGSS, 179, 1), // Mareep Egg @ Primo
    StaticTemplate4(Game::HGSS, 194, 1), // Wooper Egg
    StaticTemplate4(Game::HGSS, 218, 1) // Slugma Egg
};

constexpr std::array<StaticTemplate4, 7> gameCorner = {
    StaticTemplate4(Game::HGSS, 112, 15), // Mr. Mime @ Celadon City Game Corner
    StaticTemplate4(Game::HGSS, 133, 15), // Eevee
    StaticTemplate4(Game::HGSS, 137, 15), // Porygon

    StaticTemplate4(Game::HGSS, 63, 15), // Abra @ Goldenrod City Game Corner
    StaticTemplate4(Game::HeartGold, 23, 15), // Ekans
    StaticTemplate4(Game::SoulSilver, 27, 15), // Sandshrew
    StaticTemplate4(Game::HGSS, 147, 15) // Dratini
};

constexpr std::array<StaticTemplate4, 14> stationary = {
    StaticTemplate4(Game::DP, 425, 22), // Drifloon @ Valley Windworks
    StaticTemplate4(Game::Platinum, 425, 15), // Drifloon
    StaticTemplate4(Game::DP, 479, 15), // Rotom @ Old Chateau
    StaticTemplate4(Game::Platinum, 479, 20), // Rotom
    StaticTemplate4(Game::DPPt, 442, 25), // Spiritomb @ Route 209

    StaticTemplate4(Game::HGSS, 100, 23), // Voltorb @ Team Rocket HQ Trap Floor
    StaticTemplate4(Game::HGSS, 74, 21), // Geodude
    StaticTemplate4(Game::HGSS, 109, 21), // Koffing
    StaticTemplate4(Game::HGSS, 130, 30), // Gyrados @ Lake of Rage
    StaticTemplate4(Game::HGSS, 131, 20), // Lapras @ Union Cave
    StaticTemplate4(Game::HGSS, 101, 23), // Electrode @ Team Rocket HQ
    StaticTemplate4(Game::HGSS, 143, 50), // Snorlax @ Route 11 / Route 12
    StaticTemplate4(Game::HGSS, 185, 20), // Sudowoodo @ Route 36
    StaticTemplate4(Game::HGSS, 172, 30) // Spiky-Eared Pichu @ Ilex Forest
};

constexpr std::array<StaticTemplate4, 33> legends = {
    StaticTemplate4(Game::Platinum, 377, 30), // Regirock @ Rock Peak Ruins
    StaticTemplate4(Game::Platinum, 378, 30), // Regice @ Iceberg Ruins
    StaticTemplate4(Game::Platinum, 379, 30), // Registeel @ Iron Ruins
    StaticTemplate4(Game::DPPt, 480, 50), // Uxie @ Acuity Cavern
    StaticTemplate4(Game::DPPt, 482, 50), // Azelf @ Valor Cavern
    StaticTemplate4(Game::Diamond, 483, 47), // Diagla @ Spear Pillar
    StaticTemplate4(Game::Pearl, 484, 47), // Palkia
    StaticTemplate4(Game::Platinum, 483, 70), // Diagla
    StaticTemplate4(Game::Platinum, 484, 70), // Palkia
    StaticTemplate4(Game::DP, 485, 70), // Heatran @ Stark Mountain
    StaticTemplate4(Game::Platinum, 485, 50), // Heatran
    StaticTemplate4(Game::DP, 486, 70), // Regigigas @ Snowpoint Temple
    StaticTemplate4(Game::Platinum, 486, 1), // Regigigas
    StaticTemplate4(Game::DP, 487, 70), // Giratina @ Turnback Cave
    StaticTemplate4(Game::Platinum, 487, 47), // Giratina
    StaticTemplate4(Game::Platinum, 487, 47, 1), // Giratina @ Distortion World

    StaticTemplate4(Game::HGSS, 144, 50), // Articuno @ Seafoam Islands
    StaticTemplate4(Game::HGSS, 145, 50), // Zapdos @ Route 10
    StaticTemplate4(Game::HGSS, 146, 50), // Moltres @ Mt. Silver Cave
    StaticTemplate4(Game::HGSS, 150, 70), // Mewtwo @ Cerulean Cave
    StaticTemplate4(Game::HGSS, 245, 40), // Suicune @ Route 25 / Burned Tower
    StaticTemplate4(Game::HeartGold, 249, 70), // Lugia @ Whirl Islands
    StaticTemplate4(Game::SoulSilver, 249, 45), // Lugia
    StaticTemplate4(Game::HeartGold, 250, 45), // Ho-Oh @ Bell Tower
    StaticTemplate4(Game::SoulSilver, 250, 70), // Ho-Oh
    StaticTemplate4(Game::HeartGold, 381, 40), // Latios @ Pewter City
    StaticTemplate4(Game::SoulSilver, 380, 40), // Latias
    StaticTemplate4(Game::HeartGold, 382, 50), // Kyogre @ Embedded Tower
    StaticTemplate4(Game::SoulSilver, 383, 50), // Groudon
    StaticTemplate4(Game::HGSS, 384, 50), // Rayquaza
    StaticTemplate4(Game::HGSS, 483, 1), // Dialga @ Sinjoh Ruins
    StaticTemplate4(Game::HGSS, 484, 1), // Palkia
    StaticTemplate4(Game::HGSS, 487, 1, 1) // Giratina
};

constexpr std::array<StaticTemplate4, 2> events = {
    StaticTemplate4(Game::Platinum, 491, 50), // Darkrai @ Newmoon Island
    StaticTemplate4(Game::Platinum, 492, 30) // Shaymin @ Flower Paradise
};

constexpr std::array<StaticTemplate4, 9> roamers = {
    StaticTemplate4(Game::DPPt, 481, 50), // Mesprit
    StaticTemplate4(Game::DPPt, 488, 50), // Cresselia
    StaticTemplate4(Game::Platinum, 144, 60), // Articuno
    StaticTemplate4(Game::Platinum, 145, 60), // Zapdos
    StaticTemplate4(Game::Platinum, 146, 60), // Moltres

    StaticTemplate4(Game::HGSS, 243, 40), // Raikou
    StaticTemplate4(Game::HGSS, 244, 40), // Entei
    StaticTemplate4(Game::HeartGold, 380, 35), // Latias
    StaticTemplate4(Game::SoulSilver, 381, 35) // Latios
};
