    ...
    with open("EncounterTables/Gen8/encounters.json") as f:
        ...
        for type, encounters in data.items():
            ...
            for i, encounter in enumerate(encounters):
                string += f"StaticTemplate8({encounter['version']}, {encounter['specie']}, {encounter.get('form', 0)}, {encounter.get('shiny', 'Shiny::Random')}, {encounter.get('ability', 255)}, {encounter.get('gender', 255)}, {encounter.get('ivCount', 0)}, {encounter['level']})"
