...
Wild5::Wild5(QWidget *parent) : QWidget(parent), ui(new Ui::Wild5)
{
    ...
    ui->comboBoxGeneratorEncounter->setup({ toInt(Encounter::Grass), toInt(Encounter::Surfing), toInt(Encounter::SuperRod) });
    ui->comboBoxSearcherEncounter->setup({ toInt(Encounter::Grass), toInt(Encounter::Surfing), toInt(Encounter::SuperRod) });
...
void Wild5::generate()
{
    ...
    WildGenerator5 generator(initialAdvances, maxAdvances, delay, Method::None, lead,
...
void Wild5::search()
{
    ...
    WildGenerator5 generator(initialAdvances, maxAdvances, 0, Method::Method5, lead,
