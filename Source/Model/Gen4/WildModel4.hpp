...
private:
    QStringList header = { tr("Advances"), tr("Occidentary"), tr("Item"),  tr("Shiny Patch"), tr("Call"),    tr("Chatot"), tr("Slot"),
                           tr("Level"),    tr("PID"),         tr("Shiny"), tr("Nature"),      tr("Ability"), tr("HP"),     tr("Atk"),
