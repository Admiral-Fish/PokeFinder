...
public:
    /**
     * @brief Construct a new DreamRadarGeneratorModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    DreamRadarGeneratorModel5(QObject *parent);
...
private:
    QStringList header
        = { tr("Advances"), tr("Needle"), tr("PID"), tr("Shiny"), tr("Nature"), tr("Ability"), tr("HP"),     tr("Atk"),
...
public:
    /**
     * @brief Construct a new DreamRadarSearcherModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    DreamRadarSearcherModel5(QObject *parent);
