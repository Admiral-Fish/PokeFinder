...
private:
    QStringList header = { tr("Profile Name"), tr("Version"),    tr("Language"),    tr("TID"),        tr("SID"),    tr("MAC Address"),
                           tr("DS Type"),      tr("VCount"),     tr("Timer0"),      tr("GxStat"),     tr("VFrame"), tr("Keypresses"),
                           tr("Skip L/R"),     tr("Soft Reset"), tr("Memory Link"), tr("Shiny Charm") };
};
