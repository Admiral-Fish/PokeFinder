...
private:
    Method method;
    QStringList header = { tr("Advances"), tr("Occidentary"), tr("Held Item"), tr("Call"),    tr("Chatot"), tr("Slot"), tr("Level"),
...
private:
    Method method;
    QStringList header
        = { tr("Seed"),    tr("Advances"), tr("Lead"), tr("Held Item"), tr("Slot"), tr("Level"), tr("PID"), tr("Shiny"),  tr("Nature"),
