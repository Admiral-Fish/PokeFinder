...
#ifndef POKEWALKERMODEL_HPP
#define POKEWALKER4MODEL_HPP
...
class PokeWalkerGeneratorModel : public TableModel<PokeWalkerState>
{
    Q_OBJECT
public:
    explicit PokeWalkerGeneratorModel(QObject *parent, Method method);
...
class PokeWalkerSearcherModel : public TableModel<PokeWalkerState>
{
    Q_OBJECT
public:
    explicit PokeWalkerSearcherModel(QObject *parent, Method method);
    void setMethod(Method method);
