...
class StaticGeneratorModel4 : public TableModel<State>
{
    Q_OBJECT
public:
    explicit StaticGeneratorModel4(QObject *parent, Method method);
...
class StaticSearcherModel4 : public TableModel<StaticState>
{
    Q_OBJECT
public:
    explicit StaticSearcherModel4(QObject *parent, Method method);
    void setMethod(Method method);
