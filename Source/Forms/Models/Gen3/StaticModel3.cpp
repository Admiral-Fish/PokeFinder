...
StaticGeneratorModel3::StaticGeneratorModel3(QObject *parent) : TableModel<State>(parent)
{
}
...
StaticSearcherModel3::StaticSearcherModel3(QObject *parent) : TableModel<State>(parent)
{
}
