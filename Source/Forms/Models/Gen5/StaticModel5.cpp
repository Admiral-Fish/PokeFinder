...
StaticGeneratorModel5::StaticGeneratorModel5(QObject *parent, Method method) : TableModel<StaticState>(parent), method(method)
{
}

void StaticGeneratorModel5::setMethod(Method method)
{
    this->method = method;
...
int StaticGeneratorModel5::getColumn(int column) const
{
    switch (method)
    {
    case Method::Method5IVs:
...
StaticSearcherModel5::StaticSearcherModel5(QObject *parent, Method method) :
    TableModel<SearcherState5<StaticState>>(parent), method(method)
{
}

void StaticSearcherModel5::setMethod(Method method)
{
    this->method = method;
    emit headerDataChanged(Qt::Horizontal, 0, columnCount());
}
...
int StaticSearcherModel5::getColumn(int column) const
{
    switch (method)
    {
    case Method::Method5IVs:
