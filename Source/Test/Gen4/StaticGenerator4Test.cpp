...
void StaticGenerator4Test::generateMethod1()
{
    ...
    StaticGenerator4 generator(0, 9, 0, Method::Method1, Lead::None, true, *staticTemplate, profile, filter);
...
void StaticGenerator4Test::generateMethodJ()
{
    ...
    const StaticTemplate4 *staticTemplate = Encounters4::getStaticEncounter(category, pokemon);
    StateFilter filter(255, 255, 255, false, min, max, natures, powers);
    StaticGenerator4 generator(0, 9, 0, Method::MethodJ, lead, true, *staticTemplate, profile, filter);
...
void StaticGenerator4Test::generateMethodK()
{
    ...
    const StaticTemplate4 *staticTemplate = Encounters4::getStaticEncounter(category, pokemon);
    StateFilter filter(255, 255, 255, false, min, max, natures, powers);
    StaticGenerator4 generator(0, 9, 0, Method::MethodK, lead, true, *staticTemplate, profile, filter);
