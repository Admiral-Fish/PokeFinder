...
void WildGenerator8Test::generate()
{
    ...
    std::vector<EncounterArea8> encounterAreas = Encounters8::getEncounters(encounter, 0, false, false, &profile);
    ...
    WildGenerator8 generator(0, 9, 0, 12345, 54321, Game::BD, encounter, lead, filter);
