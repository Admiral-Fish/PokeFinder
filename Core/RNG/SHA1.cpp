...
u64 SHA1SIMD::hashSeed()
{
    ...
    MSG2.uint128 = vreinterpretq_u32_u8(vrev32q_u8(vreinterpretq_u8_u32(MSG2.uint128)));
    MSG3.uint128 = vreinterpretq_u32_u8(vrev32q_u8(vreinterpretq_u8_u32(MSG3.uint128)));
