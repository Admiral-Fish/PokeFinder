...
public:
     ...
     * @param encounterArea Phenomenon information
     * @param profile Profile Information
     * @param filter State filter
     */
    PhenomenonGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, const EncounterArea5 &encounterArea, const Profile5 &profile,
