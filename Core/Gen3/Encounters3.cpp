        ...
        std::vector<EncounterArea3> getArea(const QByteArray &data, const std::vector<PersonalInfo> &info)
        {
            ...
            if (data.at(2) == 1)
            {
                ...
                for (u8 i = 0; i < 5; i++)
                {
                    ...
                    rock.emplace_back(specie, minLevel, maxLevel, info.at(specie));
                }
            ...
            if (data.at(3) == 1)
            {
                ...
                for (u8 i = 0; i < 5; i++)
                {
                    ...
                    surf.emplace_back(specie, minLevel, maxLevel, info.at(specie));
                }
                ...
                for (u8 i = 0; i < 2; i++)
                {
                    ...
                    old.emplace_back(specie, minLevel, maxLevel, info.at(specie));
                }
                ...
                for (u8 i = 0; i < 3; i++)
                {
                    ...
                    good.emplace_back(specie, minLevel, maxLevel, info.at(specie));
                }
                ...
                for (u8 i = 0; i < 5; i++)
                {
                    ...
                    super.emplace_back(specie, minLevel, maxLevel, info.at(specie));
                }
