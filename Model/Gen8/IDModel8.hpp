...
/**
 * @brief Provides a table model implementation to show TID/SID information for Gen 8
 */
class IDModel8 final : public TableModel<IDState8>
{
    Q_OBJECT
public:
    /**
...
private:
    QStringList header = { tr("Advances"), tr("Display TID"), tr("TID"), tr("SID"), tr("TSV") };
};
