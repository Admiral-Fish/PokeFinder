...
private:
    QStringList header = { tr("Seed"),      tr("Lead"),   tr("Advances"), tr("IV Advances"), tr("Item"),   tr("Slot"),
                           tr("Level"),     tr("PID"),    tr("Shiny"),    tr("Nature"),      tr("Ability"), tr("HP"),
                           tr("Atk"),       tr("Def"),    tr("SpA"),      tr("SpD"),         tr("Spe"),     tr("Hidden"),
                           tr("Power"),     tr("Gender"), tr("Characteristic"), tr("Date/Time"), tr("Timer0"), tr("Buttons") };
    bool showStats;
};
