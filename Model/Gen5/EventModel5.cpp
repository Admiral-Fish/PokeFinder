...
EventGeneratorModel5::EventGeneratorModel5(QObject *parent) : TableModel(parent), showStats(false), showSaveNeedles(false)
{
}
...
void EventGeneratorModel5::setShowSaveNeedles(bool flag)
{
