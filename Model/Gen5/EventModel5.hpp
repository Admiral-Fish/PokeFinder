...
public:
    /**
     * @brief Construct a new EventGeneratorModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    EventGeneratorModel5(QObject *parent);
...
private:
    QStringList header
        = { tr("Advances"), tr("Chatot"), tr("Needle"), tr("PID"),   tr("Shiny"), tr("Nature"), tr("Ability"), tr("HP"),    tr("Atk"),
...
public:
    /**
     * @brief Construct a new EventSearcherModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    EventSearcherModel5(QObject *parent);
