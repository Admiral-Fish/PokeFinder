...
static QString getLuckyPower(PassPower power)
{
    ...
    case PassPower::Level1:
        return QCoreApplication::translate("Wild5", "Lucky Power 1");
    case PassPower::Level2:
        return QCoreApplication::translate("Wild5", "Lucky Power 2");
    case PassPower::Level3:
        return QCoreApplication::translate("Wild5", "Lucky Power 3");
    case PassPower::LevelS:
        return QCoreApplication::translate("Wild5", "Lucky Power S");
    default:
        return QCoreApplication::translate("Wild5", "None");
    }
}
...
QVariant WildSearcherModel5::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (role == Qt::DisplayRole && orientation == Qt::Horizontal)
    {
        if (section == 1)
        {
            return QCoreApplication::translate("Wild5", "Lucky Power");
        }
        return header[section];
    }
    return QVariant();
