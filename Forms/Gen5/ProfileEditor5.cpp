...
void ProfileEditor5::setupModels()
{
    ...
    ui->textBoxMAC->setValues(0, 0xFFFFFFFFF, 16);
    ui->textBoxVCount->setValues(0, 0xFF, 16);
    ui->textBoxGxStat->setValues(0, 99, 10);
    ui->textBoxVFrame->setValues(0, 99, 10);
...
void ProfileEditor5::on_pushButtonAccept_clicked()
{
    ...
    fresh = Profile5(ui->lineEditProfile->text(), static_cast<Game>(ui->comboBoxVersion->currentData().toInt()), ui->textBoxTID->getUShort(),
                     ui->textBoxSID->getUShort(), ui->textBoxMAC->getULong(), ui->comboBoxKeypresses->getChecked(), ui->textBoxVCount->getUShort(),
                     ui->textBoxGxStat->getUShort(), ui->textBoxVFrame->getUShort(), ui->checkBoxSkipLR->isChecked(), ui->textBoxTimer0Min->getUShort(),
                     ui->textBoxTimer0Max->getUShort(), ui->checkBoxSoftReset->isChecked(), static_cast<DSType>(ui->comboBoxDSType->currentData().toInt()),
