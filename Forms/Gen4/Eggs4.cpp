...
{
    connect(
        ui->comboBoxProfiles, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &Eggs4::profilesIndexChanged);
...
{
    generatorModel = new Egg4GeneratorModel(ui->tableViewGenerator, PokeFinderCore::Method::DPPtIVs);
    searcherModel = new Egg4SearcherModel(ui->tableViewSearcher, PokeFinderCore::Method::DPPtIVs);
...
void Eggs4::generate()
{
    ...
    PokeFinderCore::Egg4 generator(
        maxResults, startingFrame, tid, sid, method, seed, ui->comboBoxGeneratorGenderRatio->currentData().toUInt());
