...
{
    dpptModel = new SeedtoTime4Model(ui->tableViewDPPtSearch, false);
    dpptCalibrateModel = new SeedtoTime4Model(ui->tableViewDPPtCalibrate, true);
    hgssModel = new SeedtoTime4Model(ui->tableViewHGSSSearch, false, PokeFinderCore::Game::HeartGold);
    hgssCalibrateModel
        = new SeedtoTime4Model(ui->tableViewHGSSCalibrate, true, PokeFinderCore::Game::HeartGold);
