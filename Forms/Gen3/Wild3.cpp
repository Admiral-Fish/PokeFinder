...
{
    connect(
        ui->comboBoxProfiles, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &Wild3::profilesIndexChanged);
...
void Wild3::setupModels()
{
    ...
    connect(
        ui->tableViewGenerator, &QTableView::customContextMenuRequested, this, &Wild3::tableViewGeneratorContextMenu);
...
void Wild3::search()
{
    ...
    searcherModel->setMethod(static_cast<PokeFinderCore::Method>(ui->comboBoxGeneratorMethod->currentData().toInt()));
