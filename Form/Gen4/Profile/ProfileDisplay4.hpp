...
#ifndef PROFILEDISPLAY4_HPP
#define PROFILEDISPLAY4_HPP
 ...
 */
class ProfileDisplay4 final : public QWidget
{
    Q_OBJECT
signals:
    /**
     ...
     */
    void profileChanged(const Profile4 &);
...
public:
    /**
     * @brief Construct a new ProfileDisplay4 object
     *
     * @param parent Parent widget, which takes memory ownership
     */
    ProfileDisplay4(QWidget *parent = nullptr);

    /**
     * @brief Destroy the ProfileDisplay4 object
     */
    ~ProfileDisplay4() override;
