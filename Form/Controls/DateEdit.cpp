...
void DateEdit::setDateRange(Date min, Date max)
{
    setMinimumDate(QDate::fromJulianDay(min.getJD()));
    setMaximumDate(QDate::fromJulianDay(max.getJD()));
}