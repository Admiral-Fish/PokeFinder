        ...
        if (!model.empty())
        {
            ...
            case PokeFinderCore::Method::MethodH4:
                ...
                case 0:
                    std::sort(model.begin(), model.end(),
                        [flag](const PokeFinderCore::Frame3 &frame1, const PokeFinderCore::Frame3 &frame2) {
                ...
                case 2:
                    std::sort(model.begin(), model.end(),
                        [flag](const PokeFinderCore::Frame3 &frame1, const PokeFinderCore::Frame3 &frame2) {
                            return flag ? frame1.getEncounterSlot() < frame2.getEncounterSlot()
            ...
            case PokeFinderCore::Method::Colo:
                ...
                case 14:
                    std::sort(model.begin(), model.end(),
                        [flag](const PokeFinderCore::Frame3 &frame1, const PokeFinderCore::Frame3 &frame2) {
                            return flag ? frame1.getLockReason() < frame2.getLockReason()
                                        : frame1.getLockReason() > frame2.getLockReason();
                        });
                    break;
                }
                break;
        ...
        if (role == Qt::DisplayRole)
        {
            ...
            case PokeFinderCore::Method::MethodH4:
                ...
                case 1:
                {
                    ...
                    return type == PokeFinderCore::Lead::None
                        ? tr("None")
                        : type == PokeFinderCore::Lead::Synchronize ? tr("Synch") : tr("Cute Charm");
                }
                case 2:
