    ...
    if (!model.empty())
    {
        ...
        case 0:
            std::sort(model.begin(), model.end(),
                      [flag](const SearcherState5<EggState> &currentState1, const SearcherState5<EggState> &currentState2) {
        ...
        case 11:
            std::sort(model.begin(), model.end(),
                      [flag, column](const SearcherState5<EggState> &currentState1, const SearcherState5<EggState> &currentState2) {
