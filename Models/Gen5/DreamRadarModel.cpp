...
DreamRadarGeneratorModel5::DreamRadarGeneratorModel5(QObject *parent) : TableModel<Frame>(parent)
{
}
...
DreamRadarSearcherModel5::DreamRadarSearcherModel5(QObject *parent) : TableModel<SearcherFrame5<Frame>>(parent)
{
}
