...
void Egg4GeneratorModel::setMethod(PokeFinderCore::Method method)
{
    this->method = method;
...
int Egg4GeneratorModel::columnCount(const QModelIndex & /*parent*/) const
{
    switch (method)
    {
    case PokeFinderCore::Method::Gen4Normal:
    case PokeFinderCore::Method::Gen4Masuada:
        return 6;
    case PokeFinderCore::Method::DPPtIVs:
        return 10;
    case PokeFinderCore::Method::HGSSIVs:
        return 11;
    default:
        return 0;
    }
...
Egg4SearcherModel::Egg4SearcherModel(QObject *parent, PokeFinderCore::Method method)
    : TableModel<PokeFinderCore::Frame4>(parent)
{
    this->method = method;
    showInheritance = false;
...
void Egg4SearcherModel::setMethod(PokeFinderCore::Method method)
{
    this->method = method;
    emit headerDataChanged(Qt::Horizontal, 0, columnCount());
}
...
int Egg4SearcherModel::columnCount(const QModelIndex & /*parent*/) const
{
    ...
    case PokeFinderCore::Method::HGSSIVs:
        return 10;
    case PokeFinderCore::Method::Gen4Combined:
        return 16;
    default:
        return 0;
    }
