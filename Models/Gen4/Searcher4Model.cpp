        ...
        if (!model.empty())
        {
            ...
            switch (method)
            {
                ...
                case PokeFinderCore::Method::ChainedShiny:
                    ...
                    {
                        case 0:
                            std::sort(model.begin(), model.end(), [flag] (const PokeFinderCore::Frame4 & frame1, const PokeFinderCore::Frame4 & frame2)
                            {
                ...
                case PokeFinderCore::Method::MethodK:
                    switch (column)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            std::sort(model.begin(), model.end(), [flag, stat] (const PokeFinderCore::Frame4 & frame1, const PokeFinderCore::Frame4 & frame2)
                            {
                                return stat ?
